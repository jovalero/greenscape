...
class Conexion:
    ...
    def buscar_usuario_por_id(self, id_usuario):
        ...
        self.cursor.execute("SELECT id_usuario, nombre, telefono, password, email, tipo_usuario FROM usuario WHERE id_usuario = ?", (id_usuario,))
        ...
        if usuario_data: 
            usuario = Usuario(
                ...
                tipo_usuario=usuario_data[4],
                telefono=usuario_data[5]
            )
            return usuario
        return None
    ...
    def crear_base(self):
        ...
        if not usuarios:
            self.insertar_usuario("Ehizer","11733653924","jolux2","ehizer@gmail.com","Admin")